#!/usr/bin/env python3
"""
Debug script to find exactly where initialization fails
"""
...
def test_init_with_try_catch():
    ...
    try:
        ...
        if hasattr(scraper, 'focus_stocks'):
            ...
            print(f"✓ First stock: {list(scraper.focus_stocks.items())[0]}")
        else:
            print("✗ Focus stocks not found")
...
def test_class_definition():
    ...
    try:
        ...
        if 'focus_stocks' in init_source:
            print("✓ focus_stocks found in __init__ source")
        else:
            print("✗ focus_stocks NOT found in __init__ source")
